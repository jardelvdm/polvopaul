...
const API = {
    ...
    jogadoresStats: (idTemporada,idTime) =>  new Promise((resolve,reject) => API.stats.season.teamplayer_facts(idTemporada,idTime).then(data => resolve(Object.values(data))).catch(err => reject(err))),
}
